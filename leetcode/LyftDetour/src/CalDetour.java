	...
	public static void main(String args[]){
		...
		// Print result 
			if(distance_ACB <= distance_CAD){
				System.out.println("Drivers should take route A to C to B. Total Distance: "+df.format(distance_ACB)+" KM");
			}else{
				System.out.println("Drivers should take route C to A to D. Total Distance: "+df.format(distance_CAD)+" KM");
			}
	}
