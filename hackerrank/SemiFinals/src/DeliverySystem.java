...
public class DeliverySystem {
	...
	public static int searchNext(int startingCity, int currentCity, HashMap<Integer, List<Integer>> graph, ArrayList<Integer> cityToVisit, List<Integer> visited, List<Integer> path){
	...
	public static boolean equalLists(List<Integer> one, List<Integer> two){     
	    ...
	    if(one.get(0) == two.get(0) && one.get(one.size()-1) == two.get(one.size()-1))
	    	return true;
	    else
	    	return false;
	}
